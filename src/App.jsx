              ...
              <div>
                ...
                {serviceForm.features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-2 mb-2">
                    <Input
                      value={feature}
                      onChange={(e) => setServiceForm(prev => ({ ...prev, features: prev.features.map((f, i) => i === index ? value : f) }))}
                      className="flex-grow"
                    />
        ...
        <Dialog open={showChangePassword} onOpenChange={setShowChangePassword}>
          <DialogContent className="sm:max-w-[425px]" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>أدخل كلمة المرور القديمة والجديدة.</DialogDescription>
            </DialogHeader>
